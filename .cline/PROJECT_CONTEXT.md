...
- Core entities: User, Store, Product, ProductVariant, ProductImage, Category, Cart, CartItem, Order, SellerOrder, OrderItem, Payment, Review, WishlistItem, Address, Conversation, Message, Notification, AuditLog.
