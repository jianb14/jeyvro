  ...
  return createPortal(
    <div className="fixed inset-0 z-50">
      ...
      <div
        ...
        aria-modal="true"
        className={cx(
          "absolute inset-y-0 flex w-full flex-col border-sand-200 bg-white shadow-pop dark:border-night-800 dark:bg-night-900",
          side === "right" ? "right-0 animate-slide-in-right border-l" : "left-0 animate-slide-in-left border-r",
          SIZES[size]
        )}
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6 text-sm text-sand-600 dark:text-sand-300">{children}</div>
        {footer && (
